...
- `--help` / `-h` flag with full CLI usage documentation
- CHANGELOG.md and LICENSE included in npm tarballs

### Fixed
- Health endpoint version was hardcoded at 0.1.2 — now reads from package.json
- SECURITY.md version table updated from 0.x to 1.0.x
